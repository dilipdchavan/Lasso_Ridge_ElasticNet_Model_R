rm(list=ls(all=TRUE))
setwd("C:\\DCHAVAN\\DSTI-Masters\\DilipPersonalStudy\\R-Regression-Lasso-Ridge-Elastic")
...
tarin1 = data.frame(numeric_Variables, catDummies,TotalRevenueGenerated=target_variable)[trainRows,]
